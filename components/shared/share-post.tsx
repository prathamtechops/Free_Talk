...
const variants = {
  base: "relative rounded-md flex justify-center items-center flex-col cursor-pointer min-h-[150px] min-w-[200px] border  border-text-muted-foreground transition-colors duration-200 ease-in-out",
  image:
        ...
        >
          ...
          {imageUrl ? (
            ...
            <div className="flex flex-col items-center justify-center text-xs text-muted-foreground">
              ...
              <div className="mt-3">
                <Button className="text-muted-foreground" disabled={disabled}>
                  Select
                </Button>
              </div>
            </div>
